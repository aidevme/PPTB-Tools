...
Browse [`.github/plugins/dataverse/skills/`](https://github.com/microsoft/Dataverse-skills/tree/main/.github/plugins/dataverse/skills/) for the full source.
...
For the full safety model — including confirmation flows, logging, irreversible operation handling, and planned improvements — see [docs/safety-and-guardrails.md](https://github.com/microsoft/Dataverse-skills/blob/main/docs/safety-and-guardrails.md).

## Contributing

We welcome contributions — new skills, improvements to existing ones, and bug fixes. See [CONTRIBUTING.md](https://github.com/microsoft/Dataverse-skills/blob/main/CONTRIBUTING.md) for guidelines and local-development instructions.
...
This project is licensed under the [MIT License](https://github.com/microsoft/Dataverse-skills/blob/main/LICENSE).
...
Source: [microsoft/Dataverse-skills](https://github.com/microsoft/Dataverse-skills/blob/main/README.md)
